...
RUN apt-get update && \
    apt-get -y install ca-certificates curl g++ gcc git libX11-dev libffi-dev libnss3-tools locales make bsdtar latexmk texlive-latex-recommended texlive-latex-extra\
